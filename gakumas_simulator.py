...
Original file is located at
    https://colab.research.google.com/drive/1IFTmu6UX66bO0IJieYNaWXaQAfjmgJGm
"""


# Commented out IPython magic to ensure Python compatibility.
# %%writefile gakumas_simulator.py
...
#     # 救済処理：上限を超えないものの中でコスト最大・枚数最大のものを探す
#     all_combos = []
#     for r in range(1, max_select + 1):
#       for combo in itertools.combinations(cards, r):
#         total_cost = sum([c["cost"] for c in combo])
